					...
					<div class="wrap-box flex">
						<div id="site-logo" class="clearfix">
							<div id="site-logo-inner">
								<a href="<c:url value='/'/>" rel="home" class="main-logo"> <img
									id="logo_header"
						...
						<nav id="main-nav" class="main-nav">
							<ul id="menu-primary-menu" class="menu">
								<li class="menu-item"><a href="<c:url value='/product/'/>">Product</a>
								</li>
									...
									<div class="admin_active" id="header_admin">
                                            <div class="header_avatar">
                                                                ...
                                                                <div class="content-inner">
                                                                    <div class="wrap-box">
                                                                        ...
                                                                        <div class="sc-box">
                                                                            <div class="content">
                                                                                <div class="avatar">
                                                                                    <img src="<c:url value='/resources/template/FE/images/avatar/avt-6.jpg'/>" alt="">                                                                           
                                                                                </div>
                                                                                <div class="infor">
                                                ...
                                                <div class="popup-user">
                                                    <img class="avatar" src="<c:url value='/resources/template/FE/images/avatar/avt-5.jpg'/>" alt="avatar"/>
